...
function Dashboard() {
    return(
        ...
        <div className="relative min-h-screen bg-gradient-to-br from-blue-600 via-white to-pink-600 p-8">
            {/* right */}
...
<div className="bg-white p-6 rounded-2xl hover: shadow-2xl transition duration-300 cursor-pointer">
        <h2 className="text-xl font-semibold text-gray-600 mb-2">Medication Information</h2>
